...
Heterozygous single nucleotide variants (SNVs) may exhibit allele-specific expression (ASE) as well as local allele-specific alternative mRNA processing (ASARP), including allele-specific alternative splicing (ASAS), alternative 5' initiation (ASAI), alternative 3' termination/polyadenylation (ASAT).
...
=item SOAPsnv: soap.genomics.org.cn/SOAPsnv.html
